//22-2-23 Update Push
// const fullForm = document.querySelector(".formly-form");
// console.log(fullForm.elements);
// fullForm.addEventListener("change", (e) => {
//   console.log(e.currentTarget.elements.HeroGender.value);
// });
